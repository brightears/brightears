    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href={`/${locale}/artists`} className="text-purple-600 hover:text-purple-700">
            {t('backToArtists')}
          </Link>
        </div>
      </div>
              ...
              <div className="flex-1">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                  ...
                  <div className="mt-4 md:mt-0">
                    <button className="w-full md:w-auto px-6 py-3 bg-purple-600 text-white font-semibold rounded-lg hover:bg-purple-700 transition">
                      {t('bookNow')}
                    </button>
                  </div>
                </div>
                    ...
                    {(artist.website || artist.facebook || artist.instagram || artist.lineId) && (
                      <div className="mt-6 pt-6 border-t">
                        ...
                        <div className="space-y-2">
                          ...
                          {artist.facebook && (
                            <a href={artist.facebook} target="_blank" rel="noopener noreferrer" className="flex items-center text-gray-600 hover:text-purple-600">
                          ...
                          {artist.instagram && (
                            <a href={artist.instagram} target="_blank" rel="noopener noreferrer" className="flex items-center text-gray-600 hover:text-purple-600">
                              <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
