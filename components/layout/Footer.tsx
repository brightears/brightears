          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-2">
              <div className="flex items-center mb-4">
                <span className="text-2xl font-bold text-white">Bright Ears</span>
              </div>
            ...
            {/* Quick Links */}
            <div>
              <h4 className="text-lg font-semibold text-white mb-6">{t('links')}</h4>
            ...
            {/* Legal */}
            <div>
              <h4 className="text-lg font-semibold text-white mb-6">{t('legal')}</h4>
              <ul className="space-y-4">
                <li>
                  <Link 
                    href="/terms" 
